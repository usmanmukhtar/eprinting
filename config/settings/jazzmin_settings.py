...
JAZZMIN_SETTINGS = {
    ...
    "order_with_respect_to": ["users", "memberships", "reports", "blogs", "meals", "notifications", "others" "sites"],
    ...
    "icons": {
        ...
        "index": "fas fa-home",
        "reports.BodyReport": "fa fa-file",
        "reports.FacialReport": "fa fa-file",
